...
// Release signing via android/key.properties (git-ignored). If it's absent
// (fresh checkout), the release build falls back to debug signing so builds
// still work.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "app.breeze.breeze"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // Floor at 23: flutter_secure_storage's encrypted backend needs it.
    ...
    signingConfigs {
        if (keystorePropertiesFile.exists()) {
            create("release") {
                ...
                // Sign with all schemes for broad install compatibility and
    ...
    buildTypes {
        release {
            ...
            // fall back to debug so `flutter build` still works on a checkout.
